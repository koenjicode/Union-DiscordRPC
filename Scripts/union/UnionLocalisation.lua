...
local LocalisationKey = {
    ...
    De = {
        ...
        presence_inmenus         = "In den Menüs",
        presence_jukebox         = "Hört Musik im Jukebox-Modus",
        presence_courseselect    = "Wählt eine Strecke aus",
        presence_grandprix       = "Wählt einen Grand Prix aus",
        presence_class           = "Wählt eine Geschwindigkeitsklasse aus",
        presence_racerselect     = "Wählt Charakter und Maschine aus",
        ...
        presence_racing          = "Fährt ein Rennen auf %s",
        presence_racingranked    = "Fährt ein gewertetes Rennen auf %s",
        presence_normalspeed     = "Normaler Geschwindigkeit",
        presence_highspeed       = "Hoher Geschwindigkeit",
        presence_sonicspeed      = "Sonic Geschwindigkeit!",
        presence_supersonicspeed = "Super-Sonic Geschwindigkeit!!",
